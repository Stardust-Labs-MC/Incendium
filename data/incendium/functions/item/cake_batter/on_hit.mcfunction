...
execute if score $hunger in.dummy matches 1.. run tellraw @s {"translate": "%1$s%4733088$s","with":["You've eaten too much cake and received a stomach ache",{"translate":"incendium.item.cake.system.ache"}], "color": "#ff69b4"}
execute if score $hunger in.dummy matches 1.. run effect give @s minecraft:hunger 5 5 

execute unless score $hunger in.dummy matches 1.. if score $feed in.dummy matches 1.. run tellraw @s {"translate": "%1$s%4733088$s","with":["Yum",{"translate":"incendium.item.cake.system.yum"}], "color": "#ffddf4"}
