...
execute if score #hit in.fire_laser matches 0 if score $distance in.fire_laser matches ..40 positioned ^ ^ ^0.1 rotated ~ ~ run function incendium:artifact/trident/dna/ray
