...
execute if score $failed in.dummy matches 1.. run tellraw @s [{"translate": "%1$s%4733088$s","with":["Firestorm",{"translate":"incendium.item.firestorm.name"}], "color": "#ff4400", "bold": true}, " ", {"translate": "can only load", "color":"#eb783f", "bold": false}, " ", {"translate": "%1$s%4733088$s","with":["Spectral Arrows",{"translate":"incendium.system.spectral"}], "color":"#eb783f"}]
