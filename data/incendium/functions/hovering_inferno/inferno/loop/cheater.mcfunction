...
execute if score $spell_card in.inferno matches 0 if predicate incendium:random/30 run function incendium:hovering_inferno/spell/firework/direct/main
...
execute if score $spell_card in.inferno matches ..1 if predicate incendium:random/20 run function incendium:hovering_inferno/spell/shield_lasers/random
