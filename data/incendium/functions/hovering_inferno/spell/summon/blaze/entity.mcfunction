...
execute at @a[distance=..100,tag=in.survival_player] run summon blaze ~ ~ ~3 {Tags:["in.checked","in.inferno_entity","in.summoned_blaze"],DeathLootTable:"incendium:entity/dune_blaze"}
execute at @a[distance=..100,tag=in.survival_player] run summon blaze ~ ~ ~-3 {Tags:["in.checked","in.inferno_entity","in.summoned_blaze"],DeathLootTable:"incendium:entity/dune_blaze"}
