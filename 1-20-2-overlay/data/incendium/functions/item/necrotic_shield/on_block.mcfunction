...
summon area_effect_cloud ~ ~0.25 ~ {id:"minecraft:area_effect_cloud",Particle:"large_smoke",ReapplicationDelay:200,Radius:0.5f,RadiusPerTick:0.8f,Duration:10,Color:0,effects:[{id:"minecraft:wither",amplifier:2b,duration:100,show_particles:1b}],Tags:["in.necrotic_wither"]}
